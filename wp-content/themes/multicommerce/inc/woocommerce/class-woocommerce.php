<?php
/**
 * MultiCommerce WooCommerce Class
 *
...
if ( ! class_exists( 'Multicommerce_WooCommerce' ) ) :

	/**
	 * The MultiCommerce WooCommerce Integration class
	 */
	class Multicommerce_WooCommerce {
		...
		public function products_per_page() {
			return intval( apply_filters( 'multicommerce_filter_products_per_page', 12 ) );
		}
...
return new Multicommerce_WooCommerce();